...
function resizeText() {
  ...
  <?php
   ...
   define ('DB_USER', 'elizeweb_softwar');
   define ('DB_PASSWORD', 'CS3398');
   define ('DB_HOST', 'box1240.bluehost.com');
   define ('DB_NAME', 'elizeweb_wordpressd48');
    ...
    <div class="header_section">
      ...
      <nav class="nav" id="nav">
        <ul class="toggle">
          ...
          <li><a href="#service">Login/Register</a></li>
          <li><a href="#work_outer">Add Food</a></li>
          <li><a href="#Portfolio">Carb Log</a></li>
        ...
        <div class="row">
          <div class="col-lg-5 col-sm-7">
            <div class="top_left_cont flipInY wow animated">
              <h3>Welcome to Carby</h3>
              <h2>Count your carbs Quickly &amp Easily!</h2>
              <p> You can pick from our large lists of foods or add your own. Start by creating an account today! </p>
              <a href="#service" class="learn_more2">Sign up!</a> </div>
          </div>
          ...
          <div class="service-list">
            ...
            <div class="service-list-col2">
              <h2>Search for a food</h2>
                <form id="searchform" action="search.php?go" method="post"><input name="name" type="text" />
                <input name="submit" type="submit" value="Search" action="search.php"/></form>
            </div>
          </div>
          <div class="service-list">
            ...
            <div class="service-list-col2">
              ...
              <form action="addfood.php" method="post">Food Name <input    name="FoodName" type="text" /> <br>
                  Grams <input name="Grams" type="text" /> <br>
                  Oz <input name="OZ" type="text" /><br>
                  Carbs <input name="Carbs" type="text" /> <br>
                  <input type="Submit" action="addFood.php"/></form>
            </div>
          </div>
         
         
          <div class="work_bottom">  <a href="#contact" class="contact_btn">Add Food</a> </div>
        </div>
